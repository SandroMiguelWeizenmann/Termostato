...
int read_data() {
   ...
   unsigned char readMS = i2c_read();
   i2c_send_ack();

   unsigned char readLS = i2c_read();
   i2c_send_nack();
   i2c_stop();
...
# 179 "termometro.c"
    ...
    int menor, maior, i;
    unsigned char u,d,c,j=150, w = 0;
    int m, termometro;

    i2c_init();

    menor = EEPROM_Read(0xFF);
    menor = menor + 100;
    maior = EEPROM_Read(0xFE);
    maior = maior + 100;

    while(1){
       ADCON0bits.GODONE = 1;
       if(j>=150){
  termometro = read_data();
  _delay((unsigned long)((40)*(16000000/4000.0)));
  termometro = termometro*1.25;
  ...
  i = termometro;
   ...
   if (PORTBbits.RB1==1 && PORTBbits.RB0==0 && PORTAbits.RA4 == 1){
  PORTAbits.RA3 = 0;
        PORTAbits.RA6 = 0;
  PORTAbits.RA5 = 1;
  w = 1;
  ...
  menor = i;
    ...
    if (PORTBbits.RB1==0 && PORTBbits.RB0==0 && PORTAbits.RA4 == 1){
  PORTAbits.RA3 = 0;
  PORTAbits.RA5 = 0;
  PORTAbits.RA6 = 1;
  w = 1;
  ...
  maior = i;
      ...
      if(PORTBbits.RB1==1 && PORTBbits.RB0==1 && PORTAbits.RA4 == 1){
  PORTAbits.RA3 = 0;
  PORTAbits.RA6 = 0;
  PORTAbits.RA5 = 1;
  if(w ==1){
  ...
  i = menor;
      ...
      if(PORTBbits.RB1==0 && PORTBbits.RB0==1 && PORTAbits.RA4 == 1){
  PORTAbits.RA3 = 0;
  PORTAbits.RA5 = 0;
         PORTAbits.RA6 = 1;
  if(w ==1){
